...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/dudakovict/simplebank/db/sqlc Store
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/dudakovict/simplebank/worker TaskDistributor
